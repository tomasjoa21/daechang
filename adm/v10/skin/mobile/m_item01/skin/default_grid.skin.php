...
#<?=$bid?> .itdiv .itul{width:100%;margin:0 auto;}
#<?=$bid?> .itdiv .itul:after{display:block;visibility:hidden;clear:both;content:"";}
#<?=$bid?> .itdiv .itul .itli{border:1px solid #c7c7c7;float:left;margin-top:<?=$it_margin?>px;margin-left:<?=$it_margin?>px;background:<?=$basic_bg_color?>;}
...
#<?=$bid?> .itdiv .itul .itli > a .itimg{overflow:hidden;}
#<?=$bid?> .itdiv .itul .itli > a .itimg img{border-bottom:1px solid #c7c7c7;}
/*#<?=$bid?> .itdiv .itul .itli > a .itimg img{transform:scale(1);-webkit-transform:scale(1);-moz-transform:scale(1);-ms-transform:scale(1);-o-transform:scale(1);transition:all 0.3s ease-in-out;}
...
#<?=$bid?> .itdiv .itul .itli .itinfo{text-align:center;padding:5px 10px;height:<?=$info_height_size?>px;overflow:hidden;}
...
#<?=$bid?> .itdiv .itul .itli .itinfo > a .it_id{color:<?=$id_font_color?>;font-size:<?=$id_font_size?>px;margin-top:8px;}
#<?=$bid?> .itdiv .itul .itli .itinfo > a .it_name{color:<?=$name_font_color?>;font-size:<?=$name_font_size?>px;font-weight:600;margin-top:8px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap;height:1.5em;line-height:1.5em;}
#<?=$bid?> .itdiv .itul .itli .itinfo > a .it_basic{color:<?=$basic_font_color?>;font-size:<?=$basic_font_size?>px;margin-top:8px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap;height:1.5em;line-height:1.5em;}
#<?=$bid?> .itdiv .itul .itli .itinfo > a .it_cust_price{color:<?=$custprice_font_color?>;font-size:<?=$custprice_font_size?>px;margin-top:8px;text-decoration:line-through;}
#<?=$bid?> .itdiv .itul .itli .itinfo > a .it_price{color:<?=$price_font_color?>;font-size:<?=$price_font_size?>px;margin-top:8px;font-weight:600;}
...
<script>
var <?=$bid?>_ratio = <?=$it_ratio?>;
var <?=$bid?>_twd = $('body').width() - <?=$dif_width?> - <?=($total_horizontal_interval*2)?>;
var <?=$bid?>_wd = <?=$bid?>_twd / <?=$item_mod_cnt?>;
var <?=$bid?>_ht = <?=$bid?>_wd / <?=$bid?>_ratio;
$('#<?=$bid?> .itdiv .itul .itli').css({'width':<?=$bid?>_wd});
$('#<?=$bid?> .itdiv .itul .itli > a .itimg img').css({'width':<?=$bid?>_wd,'height':<?=$bid?>_ht});

$(window).resize(function(){
	<?=$bid?>_twd = $('body').width() - <?=$dif_width?> - <?=($total_horizontal_interval*2)?>;
	<?=$bid?>_wd = <?=$bid?>_twd / <?=$item_mod_cnt?>;
