	...
	<tbody>
		<tr>
			...
			<td class="bwg_help">
				...
				<?php
				$item_mod_cnt = (isset($item_mod_cnt)) ? $item_mod_cnt : 2;
				echo bpwg_input_range('bwo[item_mod_cnt]',$item_mod_cnt,$w,1,5,1,'100%',32,'개');
				?>
			</td>
			<th>목록출력<br>줄 수</th>
			<td class="bwg_help">
		...
		<tr>
			<th>전체영역<br>좌우여백</th>
			<td colspan="<?=$colspan2?>" class="bwg_help">
				<?php echo bwg_help("상품목록 전체영역의 좌우 여백크기를 설정하세요.(미세조정은 키보드의 방향키로 하세요.)",1,'#555555','#eeeeee'); ?>
				<?php
				$total_horizontal_interval = (isset($total_horizontal_interval)) ? $total_horizontal_interval : 0;
				echo bpwg_input_range('bwo[total_horizontal_interval]',$total_horizontal_interval,$w,0,30,1,'147',45,'px');
				?>
			</td>
			<th>섬네일<br>가로너비</th>
			<td colspan="<?=$colspan2?>" class="bwg_help">
				...
				echo bpwg_input_range('bwo[thumb_width_size]',$thumb_width_size,$w,200,400,2,'147',38,'px');
				?>
			</td>
			<th>섬네일<br>세로높이</th>
			<td colspan="<?=$colspan2?>" class="bwg_help">
				...
				<?php
				$thumb_height_size = (isset($thumb_height_size)) ? $thumb_height_size : 320;
		...
		<tr>
			...
			<td colspan="<?=$colspan2?>" class="bwg_help">
				...
				<?php
				$title_top_interval = (isset($title_top_interval)) ? $title_top_interval : 40;
			...
			<td colspan="<?=$colspan2?>" class="bwg_help">
				...
				<?php
				$title_bottom_interval = (isset($title_bottom_interval)) ? $title_bottom_interval : 20;
		...
		<tr>
			<th>블라인드<br>아이콘색상</th>
			<td class="bwg_help">
				<?php echo bwg_help("블라인드 아이콘색상을 설정하세요.",1,'#555555','#eeeeee'); ?>
				<?php echo bpwg_input_color('bwo[blind_icon_color]',$blind_icon_color,$w,0); ?>
			</td>
			<th>블라인드<br>색상투명도</th>
			<td colspan="<?=$colspan3?>" class="bwg_help">
				<?php echo bwg_help("블라인드의 색상/투명도를 설정하세요.",1,'#555555','#eeeeee'); ?>
				<?php echo bpwg_input_color('bwo[blind_color]',$blind_color,$w,1); ?>
			</td>
			<th>목록간<br>좌우간격</th>
			<td colspan="<?=$colspan2?>" class="bwg_help">
				<?php echo bwg_help("목록간의 좌우간격을 설정하세요.(미세조정은 키보드의 방향키로 하세요.)",1,'#555555','#eeeeee'); ?>
				<?php
				$item_horizontal_interval = (isset($item_horizontal_interval)) ? $item_horizontal_interval : 0;
				echo bpwg_input_range('bwo[item_horizontal_interval]',$item_horizontal_interval,$w,0,50,1,'147',38,'px');
				?>
			</td>
			<th>정보영역<br>높이</th>
			<td colspan="<?=$colspan2?>" class="bwg_help">
				...
				<?php
				$info_height_size = (isset($info_height_size)) ? $info_height_size : 100;
		...
		<tr>
			...
			<td class="bwg_help">
				...
				<?php
				$name_font_size = (isset($name_font_size)) ? $name_font_size : 18;
			...
			<td colspan="<?=$colspan3?>" class="bwg_help">
				...
				<?php
				$price_font_size = (isset($price_font_size)) ? $price_font_size : 17;
		...
		<tr>
			...
			<td class="bwg_help">
				...
				<?php
				$listlink_width_size = (isset($listlink_width_size)) ? $listlink_width_size : 160;
			...
			<td class="bwg_help">
				...
				<?php
				$listlink_height_size = (isset($listlink_height_size)) ? $listlink_height_size : 40;
		...
		<tr>
			<th>목록테두리<br>라인색상</th>
			<td class="bwg_help">
				<?php echo bwg_help("목록의 테두리 라인색상을 설정하세요.",1,'#555555','#eeeeee'); ?>
				<?php echo bpwg_input_color('bwo[list_line_color]',$list_line_color,$w,0); ?>
			</td>
			<th>방향아이콘<br>색상</th>
			<td class="bwg_help">
				<?php echo bwg_help("슬라이드스킨 적용시 방향버튼의 색상을 설정하세요.",1,'#555555','#eeeeee'); ?>
				<?php echo bpwg_input_color('bwo[arrow_icon_color]',$arrow_icon_color,$w,0); ?>
			</td>
			<th class="sthd_bg1">방향아이콘<br>크기</th>
			<td class="bwg_help">
				<?php echo bwg_help("슬라이드스킨 적용시 방향버튼의 크기를 설정하세요.(미세조정은 키보드의 방향키로 하세요.)",1,'#555555','#eeeeee'); ?>
				<?php
				$arrow_icon_size = (isset($arrow_icon_size)) ? $arrow_icon_size : 30;
				echo bpwg_input_range('bwo[arrow_icon_size]',$arrow_icon_size,$w,5,50,1,'100%',38,'px');
				?>
			</td>
			...
			<td class="bwg_help">
				...
				<?php
				$listlink_top_interval = (isset($listlink_top_interval)) ? $listlink_top_interval : 20;
			...
			<td colspan="<?=$colspan3?>" class="bwg_help">
				...
				<?php
				$listlink_bottom_interval = (isset($listlink_bottom_interval)) ? $listlink_bottom_interval : 30;
