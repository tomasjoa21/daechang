...
#<?=$bid?> .plx_img{height:<?=$bnr_ht?>px;position:relative;background-repeat:no-repeat;background-position:center center;background-size:cover;}
...
#<?=$bid?> .plx_img .plx_wrap{position:relative;z-index:3;width:100%;height:100%;margin:0 auto;}
