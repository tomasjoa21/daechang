...
(4)<strong style="color:blue">페이지 부하를 줄이기 위해서 여기서는 동영상을 사용하지 않습니다.</strong><br>
						...
						<table class="info">
							...
							<tbody>
								...
								<tr>
									<th>유튜브URL</th>
									<td>
										<input type="text" placeholder="여기서는 동영상을 사용할 수 없습니다." disabled name="bwgc_ytb_url[<?=$row['bwgc_idx']?>]" value="<?=$row['bwgc_ytb_url']?>">
									</td>
									<th>전체링크</th>
									<td>
