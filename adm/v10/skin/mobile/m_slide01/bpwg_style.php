...
#<?=$bid?> .dv_slk .slick-prev{left:10px;}
#<?=$bid?> .dv_slk .slick-next{right:10px;}
#<?=$bid?> .dv_slk .slick-dots{bottom:20px;}
#<?=$bid?> .dv_slk .slick-dots li{width:16px;height:16px;margin:0 5px;transition:width .4s ease-in-out;}
