	...
	<tbody>
		...
		<tr>
			...
			<td class="bwg_help">
				...
				echo bpwg_input_range('bwo[text2_margin_top]',$text2_margin_top,$w,0,30,1,'100%',34,'px');
				?>
			</td>
		</tr>
		<tr>
			...
			<td class="bwg_help">
				...
				echo bpwg_input_range('bwo[text3_margin_top]',$text3_margin_top,$w,0,30,1,'100%',34,'px');
				?>
			</td>
		</tr>
		<tr>
			...
			<td class="bwg_help">
				...
				echo bpwg_input_range('bwo[text4_margin_top]',$text4_margin_top,$w,0,30,1,'100%',34,'px');
				?>
			</td>
		</tr>
