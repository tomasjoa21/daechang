...
동영상/이미지 표시 갯수 그리고 이미지 용량이 크면 클수록 페이지 로딩속도에 큰 영향을 미치게 됩니다.<br>
<strong style="color:red">용량이 큰 이미지는 업로드 되지 않을 수 있으니 꼭 주의 해 주시기 바랍니다.</strong><br>
<strong style="color:blue">동영상은 최대 3개까지(가능한 1개)</strong>, 그리고 <strong style="color:red;">개별 이미지 용량은 최대 300KB</strong>정도로 조정해 주시길
<strong style="color:green;">강력히 추천</strong> 드립니다.
</p>
			...
			<li class="li_con">
				<div class="con">
					...
					<div class="upcon">
						...
						<table class="info">
							<colgroup>
								<col span="1" class="bp_twdx65">
								<col span="1" style="min-width:200px;">
								<col span="1" class="bp_twdx60">
								<col span="1" style="min-width:200px;">
								<col span="1" class="bp_twdx34">
								<col span="1" class="bp_twdx63">
							</colgroup>
							<tbody>
								<tr>
									<th>설정</th>
