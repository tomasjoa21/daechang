	...
	<tbody>
		<tr>
			...
			<td class="bwg_help">
				...
				?>
				<input type="text" name="bwo[mbnr_default_wd]" class="bp_wdx82 bp_right" value="<?=$mbnr_default_wd?>">&nbsp;px
			</td>
			...
			<td class="bwg_help">
				...
				?>
				<input type="text" name="bwo[sld_wd]" class="bp_wdx82 bp_right" value="<?=$sld_wd?>">&nbsp;px
			</td>
			...
			<td class="bwg_help">
				...
				?>
				<input type="text" name="bwo[sld_ht]" class="bp_wdx82 bp_right" value="<?=$sld_ht?>">&nbsp;px
			</td>
		...
		<tr>
			...
			<td class="bwg_help">
				...
				?>
				<?php echo bwgf_select_selected($g5['bpwidget']['bwgf_horizontal_align'], 'bwo[rollimg_horizontal]', $rollimg_horizontal, 0, 1,$rollimg_disabled);//인수('pending=대기,ok=정상,hide=숨김,trash=삭제','bwgf_status(name속성)','ok(값)',0(값없음활성화),1(필수여부)) ?>
			</td>
			<th>회전이미지<br>X위치</th>
			<td class="bwg_help">
				...
				?>
				<input type="text" name="bwo[rollimg_x_pos]" class="bp_wdx82 bp_right" value="<?=$rollimg_x_pos?>">&nbsp;px
			</td>
			<th>회전이미지<br>Y위치</th>
			<td class="bwg_help">
				...
				?>
				<input type="text" name="bwo[rollimg_y_pos]" class="bp_wdx82 bp_right" value="<?=$rollimg_y_pos?>">&nbsp;px
			</td>
			<th>회전이미지<br>너비</th>
			<td class="bwg_help">
