	...
	<tbody>
		<tr>
			...
			<td class="bwg_help">
				...
				?>
				<input type="text" name="bwo[mbnr_default_wd]" class="bp_wdx84 bp_right" value="<?=$mbnr_default_wd?>">&nbsp;px
			</td>
		...
		<tr>
			...
			<td class="bwg_help">
				...
				<?php
				$text4btn_width_size = (isset($text4btn_width_size)) ? $text4btn_width_size : 320;
				echo bpwg_input_range('bwo[text4btn_width_size]',$text4btn_width_size,$w,100,400,10,'100%',38,'px');
				?>
			</td>
			...
			<td class="bwg_help">
				...
				<?php
				$text4btn_height_size = (isset($text4btn_height_size)) ? $text4btn_height_size : 60;
				echo bpwg_input_range('bwo[text4btn_height_size]',$text4btn_height_size,$w,20,100,5,'100%',38,'px');
				?>
			</td>
			<th>텍스트표시<br>지연시간</th>
			<td class="bwg_help">
