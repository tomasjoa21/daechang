...
#<?=$bid?> .lt_box .lt_con .lt_list .lt_list_ul .lt_list_li:hover{background:<?=$lst_hover_bg_color?>;color:<?=$lst_hover_font_color?>;}
#<?=$bid?> .lt_box .lt_con .lt_list .lt_list_ul .lt_list_li a{}
...
#<?=$bid?> .lt_box .lt_con .lt_list .lt_list_ul .lt_list_li:hover .subj{color:<?=$lst_hover_font_color?>;}
			...
			<a href="<?=$lst_title_href?>&wr_id=<?=$row['wr_id']?>">
				<?php if($row['wr_subject']){ ?>
					<div class="subj">
						...
						if ($row['is_notice'])
							echo "<strong>".$row['wr_subject']."</strong>";
						else
							echo $row['wr_subject'];
						?>
					</div>
