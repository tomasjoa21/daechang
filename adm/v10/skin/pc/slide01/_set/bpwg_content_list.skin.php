...
<h3>주의 사항</h3>
(1)동영상/이미지 표시 갯수 그리고 각각의 용량이 크면 클수록 페이지 로딩속도에 큰 영향을 미치게 됩니다.<br>
(2)<strong style="color:blue">동영상표시할때는 화면 전환을 <span style="color:red;">FADE로 설정</span> 해 주세요.</strong><br>
(3)<strong style="color:blue">동영상화면은 가능한 2번째 페이지부터 설정 해 주세요.</strong><br>
(4)<strong style="color:blue">서버환경의 조건에 따라 다수의 동영상은 표시가 원할하지 않을 수 있습니다<span style="color:red">(가능한 동영상은 1개만 표시를 추천)</span>.</strong><br>
(5)<strong style="color:red;">개별 이미지 용량은 최대 300KB</strong>정도로 조정해 주시길<strong style="color:green;">강력히 추천</strong> 드립니다.
</p>
