...
if($mnt_db_table=='code'&&$mnt_db_idx) {
    $code = get_table('code','cod_idx',$mnt_db_idx,'cod_code');
    $_REQUEST['mnt_db_code'] = $code['cod_code'];
}
else if($mnt_db_table=='tag_code'&&$mnt_db_idx) {
    $code = get_table('tag_code','tgc_idx',$mnt_db_idx,'tgc_code');
    $_REQUEST['mnt_db_code'] = $code['tgc_code'];
}
