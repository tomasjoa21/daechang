...
$sql = " SELECT * FROM g5_1_cast_shot ORDER BY csh_idx DESC LIMIT 1 ";
$one = sql_fetch($sql,1);
// print_r3($one);
$en_date = ($en_date) ? $en_date : substr($one['start_time'],0,10);
$en_time = ($en_time) ? $en_time : substr($one['start_time'],11);
