...
<form id="fsearch" name="fsearch" class="local_sch01 local_sch" method="get">
    <select name="item_type">
        <option value="weight_total">총장입량</option>
        <option value="weight_ingot">인고트장입량</option>
        <option value="weight_scrap">스크랩장입량</option>
    </select>
    <script>
...
<script>
// Detail graph
Highcharts.getJSON(g5_url+'/device/rdb/charge_in.php?<?=$qs?>', function(data) {
