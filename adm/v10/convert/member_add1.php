<?php
// member 디비를 복제해서 추가함
// 실행주소: http://test2.seoulouba.kr/adm/v10/convert/member_add1.php
// 로컬실행: http://localhost/souba3/www/adm/v10/convert/member_add1.php
...
for($i=0;$row=sql_fetch_array($result);$i++) {
    ...
    // 공통쿼리
    $skips = array('mb_no','mb_id','mb_name','mb_nick','mb_email','mb_hp');
    ...
    // 변수 재설정 or 변환
    $sql_commons[$i][] = " mb_id = '".G5_SERVER_TIME.$i."' ";
    $sql_commons[$i][] = " mb_name = '".G5_SERVER_TIME.$i."' ";
    $sql_commons[$i][] = " mb_nick = '".G5_SERVER_TIME.$i."' ";
    $sql_commons[$i][] = " mb_email = '".G5_SERVER_TIME.$i."@test.com' ";
    $sql_commons[$i][] = " mb_hp = '010-".rand(1111,9999)."-".rand(1111,9999)."' ";
