...
// 실행주소: http://woogle.kr/adm/v10/convert/order_change2.php
...
//		break;
	...
	// 변수 재설정{ =====================
	// 배열 변수 할당
    $row['od_keys2'] = get_keys($row['od_keys']);
    $row['od_more2'] = get_meta2('shop_order',$row['od_id']);
    //print_r2($row['od_more2']).'<br>';

	// od_more 정보 설정
    $row['od_more3'] = '';
    $row['od_more3'] = serialized_update('mb_name_saler',$row['od_keys2']['mb_name_saler'],$row['od_more3']);
    $row['od_more3'] = serialized_update('trm_name_department',$g5['department_name'][$row['trm_idx_department']],$row['od_more3']);
    $row['od_more3'] = serialized_update('mb_name_worker',$row['od_keys2']['mb_name_worker'],$row['od_more3']);
    $row['od_more3'] = serialized_update('com_idx',$row['od_keys2']['com_idx'],$row['od_more3']);
    $row['od_more3'] = serialized_update('com_name',$row['od_keys2']['com_name'],$row['od_more3']);
    $row['od_more3'] = serialized_update('od_order_type',$row['od_more2']['od_order_type'],$row['od_more3']);
    $row['od_more3'] = serialized_update('od_contract_type',$row['od_more2']['od_contract_type'],$row['od_more3']);
    $row['od_more3'] = serialized_update('od_baebon_type',$row['od_more2']['od_baebon_type'],$row['od_more3']);
    //print_r2(get_serialized($row['od_more3']));
    //echo $row['od_more3'].'<br>';
