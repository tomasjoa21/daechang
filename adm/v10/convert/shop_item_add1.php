<?php
// shop_item 디비를 복제해서 추가함
// 실행주소: http://test2.seoulouba.kr/adm/v10/convert/shop_item_add1.php
// 로컬실행: http://localhost/souba3/www/adm/v10/convert/shop_item_add1.php
...
$sql = " SELECT it_id AS it_id_max FROM g5_shop_item ORDER BY it_id DESC LIMIT 1 ";
$it = sql_fetch($sql,1);
$it_max = $it['it_id_max']+1;
...
for($i=0;$row=sql_fetch_array($result);$i++) {
    ...
    // 변수 재설정 or 변환
    // $sql_commons[$i][] = " it_id = '".strtotime('+'.$i.' second')."' ";
    $sql_commons[$i][] = " it_id = '".($it_max+$i)."' ";
