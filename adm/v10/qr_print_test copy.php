...
// $imgsrc = base64_encode(file_get_contents("https://img.lovepik.com/element/40132/3240.png_300.png"));
...
<!-- <script src="<?=G5_USER_ADMIN_URL?>/js/JSPrintManager/scripts/JSPrintManager.js"></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js"></script> -->
    ...
    <div style="text-align:center">
        ...
        <div id="card" style="width:200px;border-radius: 1px; background-color:antiquewhite;">
            <img src="<?=$imgsrc2?>" alt="Avatar" style="width:100%;border-radius: 10px 10px 0 0;">
            <div style="padding: 2px 16px;display:none;">
                <h3 style="font:bold 8px Arial">John Doe</h3>
                <p style="font:normal 7px Arial">Architect & Engineer</p>
            </div>
        </div>
        <hr />
...
<script>
    ...
    //         html2canvas(document.getElementById('card'), { width: 20, height: 20 }).then(function (canvas) {
...
// convertImageToBase64('https://miro.medium.com/fit/c/64/64/1*3wTm70KPAVCovuotmFReJA.png', convertImage);
// convertImageToBase64('https://img.lovepik.com/element/40132/3240.png_300.png', convertImage);
// function convertImage(dataUrl) {
//     // console.log(dataUrl);
//     $('#card img').attr('src',dataUrl);
// }
</script>
