...
// 정렬 떄문에 추가
@include_once($board_skin_path.'/list.order.php');
...
$write_pages = get_paging(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $page, $total_page, './board.php?bo_table='.$bo_table.'&page='.$page.'&'.$qstr);
...
if ($member['mb_level'] >= $board['bo_write_level']) {
    ...
    $write_href = short_url_clean('./write.php?bo_table='.$bo_table);
}
