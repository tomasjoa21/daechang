...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		<th scope="row">PLC 아이피/포트</th>
		<td>
            <input type="text" name="cod_plc_ip" value="<?php echo $cod['cod_plc_ip'] ?>" class="frm_input" style="width:150px;" placeholder="아이피">
            <input type="text" name="cod_plc_port" value="<?php echo $cod['cod_plc_port'] ?>" class="frm_input" style="width:50px;" placeholder="포트번호"> Port
		</td>
		<th scope="row">PLC 배열/비트번호</th>
		<td>
			<input type="text" name="cod_plc_no" value="<?php echo $cod['cod_plc_no'] ?>" class="frm_input" style="width:50px;" placeholder="배열번호">
			<input type="text" name="cod_plc_bit" value="<?php echo $cod['cod_plc_bit'] ?>" class="frm_input" style="width:50px;" placeholder="비트번호"> Bit
		</td>
	</tr>
	<tr>
