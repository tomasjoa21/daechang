...
<section id="bo_w">
    ...
    <div class="btn_fixed_top">
        <a href="<?php echo get_pretty_url($bo_table); ?>" class="btn btn_02"><i class="fa fa-times" aria-hidden="true"></i><span class="sound_only">취소</span></a>
        <button type="submit" id="btn_submit" class="btn btn_01" accesskey="s"><i class="fa fa-check" aria-hidden="true"></i><span class="sound_only">작성완료</span></button>
    </div>
    </form>
</section>
