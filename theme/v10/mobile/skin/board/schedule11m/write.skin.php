...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="write_div">
            ...
            <input type="text" name="wr_3" value="<?php echo $write['wr_3'] ?>" id="wr_3" class="frm_input" style="width:25%;" placeholder="시작시간">
            ~
            <label for="wr_4" class="sound_only">종료시간</label>
            <input type="text" name="wr_4" value="<?php echo $write['wr_4'] ?>" id="wr_4" class="frm_input" style="width:25%;" placeholder="종료시간">
        </div>
