    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <ul>
            <li>
                ...
                <input type="text" name="bo_9" id="bo_9" value="<?php echo $board['bo_9'] ?>" style="width:88%;" required class="frm_input required" placeholder="예약상태값">
                <span class="frm_info">
            ...
            <li>
                ...
                <input type="text" name="bo_8" id="bo_8" value="<?php echo $board['bo_8'] ?>" style="width:88%;" required class="frm_input required" placeholder="예약항목 설정">
                <span class="frm_info">
