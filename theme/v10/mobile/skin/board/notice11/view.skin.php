...
<div class="btn_fixed_top">
    <ul class="btn_top top btn_bo_user"> 
        ...
        <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b03 btn bt_write" title="글쓰기" style="color:#fff !important;"><i class="fa fa-plus" aria-hidden="true"></i><span class="sound_only">글쓰기</a></li><?php } ?>
    </ul>
</div>
<script>
jQuery(function($){
