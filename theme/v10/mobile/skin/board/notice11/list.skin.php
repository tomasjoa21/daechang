...
<div class="btn_fixed_top">
    <ul class="<?php echo isset($view) ? 'view_is_list btn_top' : 'btn_top top btn_bo_user';?>">
        ...
        <?php } ?>
        <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="fix_btn write_btn" title="글쓰기"><i class="fa fa-plus" aria-hidden="true"></i><span class="sound_only">글쓰기</span></a></li><?php } ?>
    </ul>
</div>
<?php } ?>
<!-- 게시판 목록 시작 -->
<div id="bo_list">
    ...
    <div id="bo_btn_top">
        ...
        <?php if ($is_checkbox) { ?>
        <div class="allchk_box" style="display:none;">
