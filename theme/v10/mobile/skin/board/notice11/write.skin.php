...
?>
<style>
.chk_box{position:relative;top:auto;right:auto;}
.chk_box input[type="checkbox"] + label{padding-left:21px;}
</style>
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="bo_w_tit write_div" style="padding-bottom:5px;">
        ...
        <div class="write_div">
            ...
            <div class="wr_content <?php echo $is_dhtml_editor ? $config['cf_editor'] : ''; ?>">
                ...
                <?php } ?>
                <textarea name="wr_content" id="wr_content" placeholder="내용" rows="10" style="padding:10px;"><?=get_text(html_purifier($content), 0)?></textarea>
        ...
        <div class="bo_w_link write_div" style="padding-bottom:5px;position:relative;">
            <label for="wr_link<?php echo $i ?>"><i class="fa fa-link" aria-hidden="true"></i> <span class="sound_only">링크 #<?php echo $i ?></span></label>
            <input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo $write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>" class="frm_input wr_link" placeholder="링크를 입력하세요" style="width:100%;">
        </div>
        <?php } ?>

        <?php for ($i=0; $is_file && $i<$file_count; $i++) { ?>
        <div class="bo_w_flie write_div" style="padding-bottom:5px;">
    ...
    <div class="btn_fixed_top">
        <a href="<?php echo get_pretty_url($bo_table); ?>" class="btn btn_02"><i class="fa fa-arrow-left" aria-hidden="true"></i><span class="sound_only">취소</span></a>
        <button type="submit" id="btn_submit" class="btn btn_01" accesskey="s"><i class="fa fa-check" aria-hidden="true"></i> OK<span class="sound_only">작성완료</span></button>
    </div>
    </form>
</section>
