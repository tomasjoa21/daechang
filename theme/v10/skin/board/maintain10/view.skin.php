...
$wr_7s = json_decode($view['wr_7'], true);
if(is_array($wr_7s)) {
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_report">
        <h2>정비내역</h2>
        <span class="item_name">설비</span> <strong><?=$mms['mms_name']?></strong>
        <br>
        <span class="item_name">정비일</span> <strong><?=$view['wr_3']?></strong>
        <span class="item_name">담당자</span> <strong><?=$view['wr_4']?></strong>
        <span class="item_name">소요시간</span> <strong><?=$view['wr_5']?></strong>
        <span class="item_name">경비</span> <strong><?=number_format($view['wr_6'])?></strong>
    </section>
