...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col">제목</th>
            <th scope="col"><?php echo subject_sort_link('wr_3', 'bo_table='.$bo_table, 'desc') ?>정비일</a></th>
            <th scope="col">담당자</th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> status_<?php echo $list[$i]['wr_10'];?>">
            ...
            <td class="td_mms_name td_left"><?=$list[$i]['sried']['mms_name']?></td><!-- 설비명 -->
            <!-- 제목 -->
            ...
            <td class="td_prior_day"><?=$list[$i]['wr_4']?></td><!-- 담당자 -->
            <td class="td_period"><?=$list[$i]['wr_5']?></td><!-- 소요시간 -->
