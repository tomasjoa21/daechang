...
<section id="bo_w">
    ...
    <!-- 정비일, 담당자, 소요시간, 정비비용 -->
    <div class="write_div">
        <input type="text" name="wr_3" value="<?=$write['wr_3']?>" id="wr_3" required class="frm_input required" style="width:90px;" placeholder="정비일">
        &nbsp;&nbsp;&nbsp;
        담당자:
        <input type="text" name="wr_4" value="<?=$write['wr_4']?>" id="wr_4" required class="frm_input required" style="width:80px;" placeholder="담당자">
        &nbsp;&nbsp;&nbsp;
        소요시간: 
        <input type="text" name="wr_5" value="<?=$write['wr_5']?>" id="wr_5" required class="frm_input required" style="width:40px;" placeholder="숫자">시간
        &nbsp;&nbsp;&nbsp;
        비용: 
        <input type="text" name="wr_6" value="<?=$write['wr_6']?>" id="wr_6" required class="frm_input required" style="width:100px;" placeholder="숫자">
    </div>
