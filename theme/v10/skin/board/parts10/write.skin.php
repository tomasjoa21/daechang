...
<section id="bo_w">
    ...
    <div class="write_div">
        ...
        <input type="text" name="mms_name" value="<?=$write['mms_name']?>" id="mms_name" required class="frm_input required" placeholder="설비명" readonly>
    ...
    <!-- 수량 -->
    <div class="write_div">
        수량: <input type="text" name="wr_4" value="<?=$write['wr_4']?>" id="wr_4" required class="frm_input required" style="width:40px;" placeholder="수량"> 개
        &nbsp;&nbsp;&nbsp;
        단가: 
        <input type="text" name="wr_3" value="<?=$write['wr_3']?>" id="wr_3" class="frm_input" style="width:100px;" placeholder="숫자">
    </div>
