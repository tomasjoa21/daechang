...
$wr_7s['r_name'] = $_REQUEST['r_name'];
$wr_7s['r_role'] = $_REQUEST['r_role'];
$wr_7s['r_hp'] = $_REQUEST['r_hp'];
$wr_7s['r_email'] = $_REQUEST['r_email'];
$wr_7 = json_encode( $wr_7s, JSON_UNESCAPED_UNICODE );
// print_r2($_REQUEST);
// echo $wr_7;
// exit;
...
$wr_9_new = serialized_update('as_tel',$_REQUEST['as_tel'],$wr_9_new);
$wr_9_new = serialized_update('as_email',$_REQUEST['as_email'],$wr_9_new);
$wr_9_new = serialized_update('wr_send_type',$_REQUEST['wr_send_type'],$wr_9_new);
