...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($is_admin) { ?><li style="display:<?php if(auth_check($auth[$sub_menu],"d",1)) echo 'none';?>none;"><a href="<?php echo $board_skin_url ?>/config_form.php?bo_table=<?php echo $bo_table;?>" class="btn_admin btn"><i class="fa fa-gear" aria-hidden="true"></i> 환경설정</a></li><?php } ?>
    ...
    <form name="fsearch" method="get">
        ...
        <div class="bo_sch_group">
            <select name="sfl" id="sfl">
                <option value="wr_subject"<?php echo get_selected($sfl, 'wr_subject', true); ?>>사업체명</option>
                <option value="wr_content"<?php echo get_selected($sfl, 'wr_content'); ?>>내용</option>
                <option value="wr_subject||wr_content"<?php echo get_selected($sfl, 'wr_subject||wr_content'); ?>>제목+내용</option>
                <option value="mb_id,1"<?php echo get_selected($sfl, 'mb_id,1'); ?>>회원아이디</option>
                <option value="mb_id,0"<?php echo get_selected($sfl, 'mb_id,0'); ?>>회원아이디(코)</option>
                <option value="wr_name,1"<?php echo get_selected($sfl, 'wr_name,1'); ?>>대표자</option>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
            <th scope="col">번호</th>
            <th scope="col" class="td_left">사업체명</th>
            <th scope="col" style="width:80px;">대표자</th>
            <th scope="col" style="width:90px;">사업자등록번호</th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> status_<?php echo $list[$i]['wr_10'];?>">
            ...
            <td class="td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px"><!-- 사업체명 -->
                <div class="bo_tit">
            ...
            <td class="td_wr_name sv_use"><?php echo $list[$i]['name'] ?></td><!-- 대표자 -->
            <td class="td_status sv_use" style="white-space:nowrap;"><!-- 사업자등록번호 -->
                <?php echo $list[$i]['sried']['com_no'] ?>
            </td>
            <td class="td_status sv_use"><!-- 상태 -->
                <?php echo $g5['set_maintain_status_value'][$list[$i]['wr_10']] ?>
            </td>
            <td class="td_datetime"><?php echo $list[$i]['datetime2'] ?></td><!-- 날짜 -->
