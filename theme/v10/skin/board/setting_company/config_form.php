...
<section id="bo_config">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <ul>
            ...
            <li>
                <label class="frm_label">운영관리 조직코드</label>
                <input type="text" name="bo_3" id="bo_3" value="<?php echo $board['bo_3'] ?>" style="width:80%;" class="frm_input" placeholder="운영 조직코드">
                <span class="frm_info">
                    <?php
                    ...
                    ?>
                    <br>
                    게시판을 운영관리해야 하는 조직의 코드들를 입력하세요. 구분자는 쉼표입니다.
                </span>                
            </li>
