...
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/timepicker/jquery.timepicker.css">', 0);
?>
...
<section id="bo_w">
    ...
    <div class="bo_user write_div">
        ...
        <input type="text" name="wr_2" id="wr_2" value="<?php echo $write['wr_2'] ?>" style="width:100px;" required class="required frm_input" placeholder="날짜">

        <input type="text" name="wr_3" id="wr_3" value="<?php echo $write['wr_3'] ?>" style="width:100px;" required class="required frm_input" placeholder="시작시간">
        부터
...
$(function(){
    ...
    $('#wr_3, #wr_4').timepicker({
        'timeFormat': 'h:i A',
        'step': <?php echo $board['set_time_unit']; ?>,
    //    'minTime': '09:00 AM',
    //    'maxTime': '06:00 PM',
    //    'disableTimeRanges': [
    //        ['12:00 PM', '01:01 PM']
