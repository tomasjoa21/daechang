...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($list_href) { ?><li><a href="<?php echo $list_href ?>&ser_com_idx=<?=$ser_com_idx?>" class="btn_b01 btn"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li><?php } ?>
    ...
    <form name="fsearch" method="get">
        ...
        <input type="hidden" name="ser_com_idx" value="<?=$ser_com_idx?>">
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php } ?>
            <?php if ($list_href) { ?><li><a href="<?php echo $list_href ?>" class="c"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li><?php } ?>
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 글쓰기</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
