...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <form name="fsearch" method="get">
        ...
        <div class="bo_sch_group">
            <select name="ser_wr_10" id="ser_wr_10" style="display:none;">
            ...
            <select name="sch_mb_asign_worker" id="sch_mb_asign_worker" style="display:none;">
            ...
            <select name="ser_wr_5" id="ser_wr_5" style="display:none;">
                <option value="">작업등급전체 &nbsp;</option>
                <?php echo $g5['set_maintain_grades_options'];?>
            </select>
            <script>$('#ser_wr_5').val('<?php echo $ser_wr_5;?>').attr('selected','selected');</script>

            <select name="sfl" id="sfl">
                <option value="wr_subject"<?php echo get_selected($sfl, 'wr_subject', true); ?>>업체명</option>
                <option value="wr_6"<?php echo get_selected($sfl, 'wr_6', true); ?>>담당자명</option>
                <option value="wr_6"<?php echo get_selected($sfl, 'wr_6', true); ?>>업체주소</option>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> status_<?php echo $list[$i]['wr_10'];?>">
            ...
            <td class="td_ca_name"><?=$list[$i]['ca_name']?></td><!-- 종목 -->
            <!-- 회사명 -->
            <td class="td_center">
                <?php echo $list[$i]['subject'] ?>
            </td>
            <td class="td_as_addr"><?=$list[$i]['wr_5']?></td><!-- 주소 -->
            <td class="td_as_name"><?=$list[$i]['wr_6']?></td><!-- 담당자명 -->
            <td class="td_mms_name"><?=$list[$i]['sried']['as_tel']?></td><!-- 전화번호 -->
            <td class="td_mms_name"><?=$list[$i]['sried']['as_email']?></td><!-- 이메일 -->
