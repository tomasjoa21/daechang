<?php
// 관리자단 move.php 권한 문제 및 게시판 리스트 범위 문제가 있어서 별도로 skin 단으로 가져옵니다. 34번줄 근처
// 복사, 이동시 추가 작업이 있을 수 있으므로 move_update.php 파일도 가지고 옵니다.
...
// 디자이너들도 게시물을 이동,복사 가능해야 함
if ($is_admin != 'board' && $is_admin != 'group' && $is_admin != 'super' && !in_array($member['mb_2'],$board['worker_trm_idxs']) )
...
if ($is_admin == 'group') {
    // 조직관리 권한을 가진 직원을 위해 인트라 그룹 게시판만 추출
    //$sql .= " and b.gr_admin = '{$member['mb_id']}' ";
    $sql .= " and b.gr_id = 'intra' ";
}
