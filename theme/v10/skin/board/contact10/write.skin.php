...
<section id="bo_w">
    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="autosave_wrapper write_div">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" style="width:474px;" maxlength="255" placeholder="업체명">
        </div>
    </div>
    <div class="bo_w_tit write_div">
        <input type="text" name="wr_5" value="<?=$write['wr_5']?>" class="frm_input" style="width:474px;" placeholder="주소">
    </div>
    <div class="bo_w_tit write_div">
        <input type="text" name="wr_6" value="<?=$write['wr_6']?>" class="frm_input" style="width:474px;" placeholder="담당자명">
    </div>
    <div class="bo_w_tit write_div">
        <input type="text" name="as_tel" value="<?=$write['as_tel']?>" class="frm_input" style="width:474px;" placeholder="전화번호" onKeyUp="chk_Number(this);">
    </div>
    <div class="bo_w_tit write_div">
        <input type="email" name="as_email" value="<?=$write['as_email']?>" class="frm_input" style="width:474px;" placeholder="이메일">
    </div>
    ...
    <div class="btn_confirm write_div">
        ...
        <?php if ($delete_href && $w=='u') { ?>
            <a href="<?php echo $delete_href ?>" class="btn_b01 btn float_right" onclick="del(this.href); return false;"><i class="fa fa-trash-o" aria-hidden="true"></i> 삭제</a>
        <?php } ?>
    </div>
    </form>
...
function fwrite_submit(f)
{
    ...
    // 휴대폰 번호 검증
    if (f.as_tel.value!='') {
        var rgEx = /(0[0-9]{1,2})[-]*(\d{4}|\d{3})[-]*\d{4}$/g; //일반전화 or 휴대폰
        var chkFlg = rgEx.test(f.as_tel.value);
        if(!chkFlg){
    ...
    if (f.as_email.value!='') {
        ...
        if (f.as_email.value.match(regExp) != null) {
            //alert('Good!');
        }
        else {
