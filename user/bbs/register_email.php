...
if(!$ckey || $ckey != $key)
    alert('올바른 방법으로 이용해 주십시오.', G5_USER_URL);
?>

<p class="rg_em_p">메일인증을 받지 못한 경우 회원정보의 메일주소를 변경 할 수 있습니다.</p>

<form method="post" name="fregister_email" action="<?php echo G5_HTTPS_USER_BBS_URL.'/register_email_update.php'; ?>" onsubmit="return fregister_email_submit(this);">
...
<div class="btn_confirm">
    ...
    <a href="<?php echo G5_USER_URL ?>" class="btn_cancel">취소</a>
</div>
